...
org.loosefx.eventbus.EventBus}, by providing a class, interface or generic type.  The EventService notifies
...
org.loosefx.eventbus.PublicationStatus} interface.  EventServices are required to set such objects' {@link
org.loosefx.eventbus.PublicationStatus} at the appropriate times during publication.
 <p/>
...
#getCachedTopicData(String)}.  Using caching while subscribing is most likely to make sense only if you subscribe
 ...
 @see {@link org.loosefx.eventbus.annotation.EventSubscriber} for subscription annotations
 @see {@link org.loosefx.eventbus.annotation.EventTopicSubscriber} for subscription annotations */
public interface EventService {
    ...
    #subscribe(Type, EventSubscriber)}, and to publish to subscribers of the non-generic type.
     ...
     using the {@link org.loosefx.eventbus.generics.TypeReference} class.  For Example:
     <pre>
    ...
    /**
     ...
     by using the {@link org.loosefx.eventbus.generics.TypeReference} class.  For Example:
     <pre>
     TypeReference&#60;List&#60;Trade&#62;&#62; subscribingTypeReference = new TypeReference&#60;List&#60;Trade&#62;&#62;(){};
     EventBus.subscribe(subscribingTypeReference.getType(), mySubscriber);
     EventBus.subscribe(List.class, thisSubscriberWillGetCalledToo);
